...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUMBER_DOUBLE = 4,              /* NUMBER_DOUBLE  */
...
static const char *const yytname[] =
{
  ...
  "NUMBER_DOUBLE", "PLUS", "MINUS", "MUL", "DIV", "POW", "LPAREN",
  "RPAREN", "FUNC", "EOL", "$accept", "start", "expression", "term",
  "factor", YY_NULLPTR
};
...
{
      -3,   -12,   -12,     1,    -4,   -12,    21,     9,    19,   -12,
      12,     1,   -12,     1,     1,   -12,     1,     1,     1,   -12,
      14,    19,    19,   -12,   -12,   -12,   -12
};
...
{
       0,    11,    12,     0,     0,     3,     0,     0,     4,     7,
       0,     0,     1,     0,     0,     2,     0,     0,     0,    13,
       0,     5,     6,     8,     9,    10,    14
};
...
{
       1,     2,    21,    22,     1,     2,    11,     3,    10,     4,
       5,     3,     0,     4,    13,    14,    20,    13,    14,    13,
      14,    12,    15,    19,     0,    26,    16,    17,    18,    23,
      24,    25
};

static const yytype_int8 yycheck[] =
{
       3,     4,    13,    14,     3,     4,    10,    10,     3,    12,
      13,    10,    -1,    12,     5,     6,    11,     5,     6,     5,
       6,     0,    13,    11,    -1,    11,     7,     8,     9,    16,
      17,    18
};
...
{
       0,     3,     4,    10,    12,    13,    15,    16,    17,    18,
      16,    10,     0,     5,     6,    13,     7,     8,     9,    11,
      16,    17,    17,    18,    18,    18,    11
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* start: expression EOL  */
#line 59 "parser.y"
                 { printf("Result: %f\n", evaluate((yyvsp[-1].node))); freeAST((yyvsp[-1].node)); return 0; }
...
#line 65 "parser.y"
                         { (yyval.node) = createNode(NODE_ADD, (Value){.dval = 0}, (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1139 "parser.tab.c"
    break;

  case 6: /* expression: expression MINUS term  */
#line 66 "parser.y"
                          { (yyval.node) = createNode(NODE_SUB, (Value){.dval = 0}, (yyvsp[-2].node), (yyvsp[0].node)); }
...
#line 71 "parser.y"
                    { (yyval.node) = createNode(NODE_MUL, (Value){.dval = 0}, (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1157 "parser.tab.c"
    break;

  case 9: /* term: term DIV factor  */
#line 72 "parser.y"
                    { (yyval.node) = createNode(NODE_DIV, (Value){.dval = 0}, (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1163 "parser.tab.c"
    break;

  case 10: /* term: term POW factor  */
#line 73 "parser.y"
                    { (yyval.node) = createNode(NODE_POW, (Value){.dval = 0}, (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1169 "parser.tab.c"
    break;

  case 11: /* factor: NUMBER_INT  */
#line 77 "parser.y"
             { (yyval.node) = createNode(NODE_NUMBER_INT, (Value){.ival = (yyvsp[0].ival)}, NULL, NULL); }
#line 1175 "parser.tab.c"
    break;

  case 12: /* factor: NUMBER_DOUBLE  */
#line 78 "parser.y"
                  { (yyval.node) = createNode(NODE_NUMBER_DOUBLE, (Value){.dval = (yyvsp[0].dval)}, NULL, NULL); }
...
#line 1187 "parser.tab.c"
  ...
  case 14: /* factor: FUNC LPAREN expression RPAREN  */
#line 80 "parser.y"
                                  { (yyval.node) = createNode(NODE_FUNC, (Value){.sval = (yyvsp[-3].sval)}, (yyvsp[-1].node), NULL); }
